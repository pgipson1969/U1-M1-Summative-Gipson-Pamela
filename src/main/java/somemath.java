public class somemath {
    public static void main(String[] args) {
        ...
        System.out.println("The total = " + total5(1, 2, 3, 4, 5));
        System.out.println("The average = " + average5(1, 3, 5, 7, 9));
        System.out.println("The largest = " + largestNumber(42.0, 35.1, 2.3, 40.2, 15.6));
    }
